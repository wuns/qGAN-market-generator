...
\begin{frame}{Take-aways}
    \begin{itemize}
        ...
        variational quantum circuit produces measurably \emph{better} cross-asset distributional structure on a specific 5-asset benchmark.
    ...
    \url{https://www.github.com/wuns/qGAN-market-generator}
    \end{center}
\end{frame}
