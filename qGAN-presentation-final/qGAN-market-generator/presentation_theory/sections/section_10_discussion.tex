...
\begin{frame}{What we found, what we did not}
    ...
    \begin{column}{.48\textwidth}
        ...
        \begin{itemize}
            ...
            plateaus
            \item Tail behaviour not fully recovered:
...
\begin{frame}{Take-aways}
    \begin{itemize}
        ...
        \item Naive intuitions about scaling fail:
        more qubits do not monotonically improve performance ---
        a known optimisation barrier (barren plateaus) bounds
        the usable regime.
    ...
    \texttt{github.com/wuns/qGAN-market-generator}
    \end{center}
\end{frame}
