...
\begin{frame}{Synthetic financial time series: a hard problem}
    ...
    \begin{column}{.40\textwidth}
        \begin{block}{Stylized facts}
            \begin{itemize}
                \item Daily returns are (almost) uncorrelated
                \item But: volatility clustering (strong positive ACF in $|r_t|$ and $r_t^2$)
    ...
    \begin{column}{.40\textwidth}
        \begin{block}{Project scope}
            \begin{itemize}
                ...
                \item Daily log-returns, 20-day rolling time windows
